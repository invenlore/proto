...
- Соблюдать стандарт именования go_package и импорта (см. раздел **Go package naming** в `templates/proto-guidelines.md`).
- Для OpenAPI использовать `openapi_naming_strategy=fqn` (см. `templates/proto-guidelines.md`).
